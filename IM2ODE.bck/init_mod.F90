...
module init_mod
    ...
    subroutine read_input()
        ...
        use parameters, only : polarization,crystal_system,crystal_system_count
        use kinds
        implicit none
        ...
        call find(nametag,"polarization",i)
        if (i==0) then
            polarization = .false.
        else
            read(number(i),*) polarization
            write(1224,*) "Input polarization"

            call find(nametag,"crystal_system_count",i)
            if (i==0) then
                crystal_system_count = 7
            else
                read(number(i), *) crystal_system_count
            end if

            call find(nametag,"crystal_system",i)
            if (i==0) then
                crystal_system = [1,2,3,4,5,6,7]
                write(1224,*) crystal_system
            else
                allocate(crystal_system(crystal_system_count))
                read(number(i), *) crystal_system
                write(1224,*) "read crystal!", crystal_system
            end if
        end if
    ...
    subroutine write_input()
        ...
        if(polarization) then
           write(1224, *) "polarization: ", polarization
           write(1224, *) "crystal_system: ", crystal_system
           write(1224, *) "crystal_system_count: ",crystal_system_count
        end if
