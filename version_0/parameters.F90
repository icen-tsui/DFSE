...
module parameters
    ...
    logical :: DMOL3, DMOL3_PBC ! control of using DMOL3 as ab initio software
    ...
    !polarization_3d
    logical :: polarization_3d
    integer(i4b), allocatable :: crystal_system_3d(:)
    integer(i4b) :: crystal_system_count_3d

    !polarization_2d
    logical :: polarization_2d
    integer(i4b), allocatable :: crystal_system_2d(:)
    integer(i4b) :: crystal_system_count_2d

    ! altermagnetic control
    logical :: altermagnetic = .false.
    integer(i4b) :: magnetic_types(max_type) = 0
    integer(i4b) :: non_magnetic_types(max_type) = 0
    integer(i4b) :: num_magnetic_types = 0, num_non_magnetic_types = 0
